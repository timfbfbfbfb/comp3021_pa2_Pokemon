/**
 This class was created to retrive the ID of a Pokemon based on its name
 author: Ming WEN
...
public class PokemonList {
	...
	/*
		The names of all Pokemons are stored in a String array in the order of the ID of the corresponding.
		In the ./icons folder, you can find the avatar of each Pokemon named with <ID>.png
	*/
	public static String[] pokemonNames = { "Bulbasaur", "Ivysaur", "Venusaur", "Charmander", "Charmeleon", "Charizard",
			...
			"Raichu", "Sandshrew", "Sandslash", "Nidoran¡â", "Nidorina", "Nidoqueen", "Nidoran¡á", "Nidorino", "Nidoking",
			...
			"Togepi", "Togetic", "Natu", "Xatu", "Mareep", "Flaaffy", "Ampharos", "Bellossom", "Marill", "Azumarill",
			...
			"Marshtomp", "Swampert", "Poochyena", "Mightyena", "Zigzagoon", "Linoone", "Wurmple", "Silcoon",
			"Beautifly", "Cascoon", "Dustox", "Lotad", "Lombre", "Ludicolo", "Seedot", "Nuzleaf", "Shiftry", "Taillow",
			"Swellow", "Wingull", "Pelipper", "Ralts", "Kirlia", "Gardevoir", "Surskit", "Masquerain", "Shroomish",
			...
			"Camerupt", "Torkoal", "Spoink", "Grumpig", "Spinda", "Trapinch", "Vibrava", "Flygon", "Cacnea", "Cacturne",
			...
			"Grotle", "Torterra", "Chimchar", "Monferno", "Infernape", "Piplup", "Prinplup", "Empoleon", "Starly",
			"Staravia", "Staraptor", "Bidoof", "Bibarel", "Kricketot", "Kricketune", "Shinx", "Luxio", "Luxray",
			...
			"Basculin", "Sandile", "Krokorok", "Krookodile", "Darumaka", "Darmanitan", "Maractus", "Dwebble", "Crustle",
			"Scraggy", "Scrafty", "Sigilyph", "Yamask", "Cofagrigus", "Tirtouga", "Carracosta", "Archen", "Archeops",
			"Trubbish", "Garbodor", "Zorua", "Zoroark", "Minccino", "Cinccino", "Gothita", "Gothorita", "Gothitelle",
			"Solosis", "Duosion", "Reuniclus", "Ducklett", "Swanna", "Vanillite", "Vanillish", "Vanilluxe", "Deerling",
			...
			"Spewpa", "Vivillon", "Litleo", "Pyroar", "Flabebe", "Floette", "Florges", "Skiddo", "Gogoat", "Pancham",
	...
	static {
		for (int i = 1; i <= pokemonNames.length; i++)
			nameToId.put(pokemonNames[i - 1], i);
	}
	
	/*
		Retrieve the ID based on the name of a Pokemon
	*/

	public static int getIdOfFromName(String name) {
